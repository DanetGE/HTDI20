...
#
# Script generated by Vivado on Mon Apr 08 23:41:36 +0200 2024
...
#
# Usage        : dist_mem_gen_1.sh
#                dist_mem_gen_1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                dist_mem_gen_1.sh [-reset_run]
#                dist_mem_gen_1.sh [-reset_log]
#                dist_mem_gen_1.sh [-help]
#
...
# script info
echo -e "dist_mem_gen_1.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./dist_mem_gen_1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L dist_mem_gen_v8_0_14 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot dist_mem_gen_1 xil_defaultlib.dist_mem_gen_1 xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb dist_mem_gen_1.wdb xsim.dir libdpi.so)
...
Usage: dist_mem_gen_1.sh [-step]\n\
Usage: dist_mem_gen_1.sh [-lib_map_path]\n\
Usage: dist_mem_gen_1.sh [-reset_run]\n\
Usage: dist_mem_gen_1.sh [-reset_log]\n\
Usage: dist_mem_gen_1.sh [-keep_index]\n\

...
#
# Script generated by Vivado on Fri Apr 12 12:05:50 +0200 2024
...
#
# Usage        : UCROM.sh
#                UCROM.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                UCROM.sh [-reset_run]
#                UCROM.sh [-reset_log]
#                UCROM.sh [-help]
#
...
# script info
echo -e "UCROM.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./UCROM.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot UCROM xil_defaultlib.UCROM xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim UCROM -key {Behavioral:sim_1:Functional:UCROM} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb UCROM.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./UCROM.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: UCROM.sh [-help]\n\
Usage: UCROM.sh [-step]\n\
Usage: UCROM.sh [-lib_map_path]\n\
Usage: UCROM.sh [-reset_run]\n\
Usage: UCROM.sh [-reset_log]\n\
Usage: UCROM.sh [-keep_index]\n\
Usage: UCROM.sh [-noclean_files]\n\n\
